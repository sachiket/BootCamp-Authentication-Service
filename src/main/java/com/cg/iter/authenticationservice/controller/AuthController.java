...
public class AuthController {
	...
	@ApiOperation(
			...
			notes = "User have to validate the mail for signup process",
			response = String.class
			)
	@RequestMapping("/confirmAccount")
	public String confirmAccount(@RequestParam String confirmationToken) {
	...
	public UserInvoiceResponse userInvoice(@RequestParam String userId) {
		return authService.getUserInvoiceResponse(userId);
	}
